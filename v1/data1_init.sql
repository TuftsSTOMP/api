...
INSERT INTO Stomper (f_name, l_name, email, username, pwd, permissions)
	VALUES 
('Devyn', 'Curley', 'InvalidEmail', 'devyn01', 'stomp','Admin'),
('Alexandria','Trombley','InvalidEmail@tufts.edu','atromb01','stomp','Stomper'),
('Ross','Kamen','Ross.Kamen@tufts.edu','rkamen01','stomp','Stomper'),
('Marc','Bucchieri','marc.bucchieri@tufts.edu','mbucch01','stomp','Stomper'),
('Laura','Fradin','laura.coughlin@tufts.edu','lfradi01','stomp','Stomper'),
('Suneeth','Keerthy','suneeth.keerthy@tufts.edu','skeert01','stomp','Stomper'),
('Akari','Miki','Akari.miki@tufts.edu','amiki01','stomp','Stomper'),
('Jen','Scinto','jennifer.scinto@tufts.edu','jscint01','stomp','Stomper'),
('Emily','Lai','emily.lai@tufts.edu','elai01','stomp','Stomper'),
('Erica','Albert','Erica.albert@tufts.edu','ealber01','stomp','Stomper'),
('Shelley','Kwok','shelley.kwok@tufts.edu','skwok01','stomp','Stomper'),
('Rohan','Joshi','Rohan.Joshi@tufts.edu','rjoshi01','stomp','Stomper'),
('Alex','Klein','Alexander.klein@tufts.edu','aklein01','stomp','Stomper'),
('Katherine','McMurray','katherine.mcmurray@tufts.edu','kmcmur01','stomp','Stomper'),
('Sara','Hogan','sara.hogan@tufts.edu','shogan01','stomp','Stomper'),
('Susan','Bitetti','smbitetti@gmail.com','sbitet01','stomp','Stomper'),
('Camila','Menard','camila.menard@tufts.edu','cmenar01','stomp','Stomper'),
('Tanya','Sinha','tanyasinha23@gmail.com','tsinha01','stomp','Stomper'),
('Daniela','Torres','daniela.torres@tufts.edu','dtorre01','stomp','Stomper'),
('Rohini','Lok','Rohini.Loke@tufts.edu','rlok01','stomp','Stomper'),
('Yash','Gurditta','yash.gurditta@tufts.edu','ygurdi01','stomp','Stomper'),
('Laura','Coughlin','laura.coughlin@tufts.edu','lcough01','stomp','Stomper'),
('Camila','Solorzano','camila.solorzano@tufts.edu','csolor01','stomp','Stomper'),
('Lois','Moon','lois.moon@tufts.edu','lmoon01','stomp','Stomper'),
('Sam','Heilbron','samheilbron@gmail.com','sheilb01','stomp','Stomper'),
('Kirsten','Jorgensen','kirsten.jorgensen@tufts.edu','kjorge01','stomp','Stomper'),
('Brian','Bertini','InvalidEmail@tufts.edu','bberti01','stomp','Stomper'),
('Eva','Philips','eva.philips@tufts.edu','ephili01','stomp','Stomper'),
('Grace','Reilly','grace.reilly@tufts.edu','greill01','stomp','Stomper'),
('Rachel','Kramer','rachelerinkramer@gmail.com','rkrame01','stomp','Stomper'),
('Orian','Sneor','alexandria.trombley@tufts.edu','osneor01','stomp','Stomper'),
('Ty','Nguyen','Nhu_Q.Nguyen@tufts.edu','tnguye01','stomp','Stomper'),
('Mile','Krstev','mile.krstev@tufts.edu','mkrste01','stomp','Stomper'),
('Caroline','Passaacque','caroline.passalacqua@tufts.edu','cpassa01','stomp','Stomper'),
('Emma','Coltoff','emma.coltoff@tufts.edu','ecolto01','stomp','Stomper'),
('Zack','Nassar','zack.nassar@tufts.edu','znassa01','stomp','Stomper'),
('Jillian','Gerke','jillian.gerke@tufts.edu','jgerke01','stomp','Stomper'),
('Caitlin','Duffy','caitlin.duffy@tufts.edu','cduffy01','stomp','Stomper'),
('Lisa','Fantini','lisa.fantini@tufts.edu','lfanti01','stomp','Stomper'),
('Elizabeth','Dossett','Elizabeth.dossett@tufts.edu','edosse01','stomp','Stomper'),
('Jerry','*','brian.bertini@tufts.edu','j*01','stomp','Stomper'),
('Simone(Daisy)','Draper','simone.draper@tufts.edu','sdrape01','stomp','Stomper'),
('Jhanel','Chew','jhanel.chew@gmail.com','jchew01','stomp','Stomper'),
('Sanya','Pradhan','sanyapradhan28@gmail.com','spradh01','stomp','Stomper'),
('Michael','Edegware','Michael.Edegware@tufts.edu','medegw01','stomp','Stomper'),
('Sara','Pearce-Probst','Sara.Pearce_Probst@tufts.edu','spearc01','stomp','Stomper'),
('Emma','Cus','emma.cusack@tufts.edu','ecus01','stomp','Stomper'),
('Jordan-Tate','Thomas','jordan-tate.thomas@tufts.edu','jthoma01','stomp','Stomper'),
('Sonja','Hartmann','InvalidEmail@tufts.edu','shartm01','stomp','Stomper'),
('Tommy','George','Thomas.George@tufts.edu','tgeorg01','stomp','Stomper'),
('Evan','Lorey','Evan.Lorey@tufts.edu','elorey01','stomp','Stomper'),
('Chris','Keyes','christopher.keyes@tufts.edu','ckeyes01','stomp','Stomper'),
('Eleanor','Richard','eleanor.richard@gmail.com','ericha01','stomp','Stomper'),
('Melissa','Moore','melissa.moore@tufts.edu','mmoore01','stomp','Stomper'),
('Lexi','Gilligan','alexandra.gilligan@tufts.edu','lgilli01','stomp','Stomper'),
('Azmina','Karukappadath','azmina.karukappadath@tufts.edu','akaruk01','stomp','Stomper'),
('Terrence','Roh','troh01@tufts.edu','troh01','stomp','Stomper'),
('Becca','Larson','rebecca.larson@tufts.edu','blarso01','stomp','Stomper'),
('Vanessa','Pinto','vanessa.pinto@tufts.edu','vpinto01','stomp','Stomper'),
('Camille-Louise','Mbayo','camille-louise.mbayo@tufts.edu','cmbayo01','stomp','Stomper'),
('Edward','Futterman','Edward.Futterman@tufts.edu','efutte01','stomp','Stomper'),
('Michael','Seleman','Michael.Seleman@tufts.edu','mselem01','stomp','Stomper'),
('Rati','Srinivasan','Rati.Srinivasan7@gmail.com','rsrini01','stomp','Stomper'),
('Sam','Slate','Samuel.Slate@tufts.edu','sslate01','stomp','Stomper'),
('Tom','Depalma','thomas.depalms@tufts.edu','tdepal01','stomp','Stomper');
